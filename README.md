...
## UNITTESTS FOR CIRCLE.PY
### Цели и задачи тестирования:
* Понять правильность работы функций в файле circle.py.
### Описание тестируемого продукта:
* В файле test_circle.py приведены несколько тестов для функций *area* и *perimeter* файла circle.py.
### Область тестирования: 
* В функции **test_area** тестируется правильность выполнения функции **area**. Были рассмотрены 2 случая:

1)


    Входные данные = 9. Ожидаемые выходные данные: значение выражения pi * 9 * 9.

    Выходные данные = pi * 9 * 9.

2)


    Входные данные = 0. Ожидаемые выходные данные = 0.

    Выходные данные = 0.


* В функции **test_perimeter** тестируется правильность выполнения функции **perimeter**. Были рассмотрены 2 случая:

1)


    Входные данные = 4. Ожидаемые выходные данные: значение выражения 2 * pi * 4.

    Выходные данные = 2 * pi * 4.
...
Эти тесты направлены на проверку случая, когда радиус окружности равен 0, то есть окружность - это точка, не имеющая ни площади ни длины дуги (они = 0), и также обычный случай, когда радиус равен какому-то числу.